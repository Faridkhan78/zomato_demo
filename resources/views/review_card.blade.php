...
{{-- <body style="background-color: wheat;"> --}}
                ...
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="ui-cards.html">Cardsss</a></li>
    ...
    {{-- <div class="min-height-200px">
        <div class="page-header">
            <button class="btn btn-primary" onclick="window.location.href='{{ route('loginpage') }}'">Logins</button>
            ...
            <div class="min-height-200px">
                <div class="page-header ">
                    ...
                    <button class="btn btn-primary"
                        onclick="window.location.href='{{ route('loginpage') }}'">Logins</button>
